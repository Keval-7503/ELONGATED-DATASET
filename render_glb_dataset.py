...
def parse_args():
    ...
    parser.add_argument("--n", type=int, default=500, help="Total number of samples")
    ...
    parser.add_argument("--category", type=str, default="toy train",
...
def main():
    ...
    print(f"Engine: {args.engine} | Seed: {args.seed} | Zoom: {args.zoom} | MinFit: {args.min_fit}")
    ...
    try:
        ...
        n_bg.inputs[1].default_value = 0.10  # dimmer world so object and shadows are visible
    ...
    for i in range(args.n):
        ...
        try:
            ...
            base_rx = math.radians(60.0)
            base_ry = 0.0
            base_rz = math.radians(30.0)
            jx = math.radians(rng.uniform(-5.0, 5.0))
